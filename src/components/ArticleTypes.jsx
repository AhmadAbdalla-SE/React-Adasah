...
export default function ArticleTypes(props) {
  return (
    <div >
        <div class="glass-card p-4 hover:scale-105 transition-transform duration-300 bg-[#161616cc]/90 w-30 border border-[#262626] rounded-2xl">
